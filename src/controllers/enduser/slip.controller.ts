 ...
 * @description Enduser slip submission — monthly intl (month+transport) OR domestic shipping (purpose=domestic)
 */
...
import { parseMonthParam, PAYMENT_RECEIPT_PURPOSE_DOMESTIC } from '../../../packages/shared/src'
